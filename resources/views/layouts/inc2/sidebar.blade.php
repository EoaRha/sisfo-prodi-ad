<div class="sidebar-wrapper" data-simplebar="true">
	<div class="sidebar-header">
		<div>
			<img src="assets2/images/logo-icon.png" class="logo-icon" alt="logo icon">
		</div>
		<div>
			<h4 class="logo-text">ITB Ad</h4>
		</div>
	...
	<ul class="metismenu" id="menu">
		...
		<li>
			...
			<ul>
				<li> <a href="{{ url('/dashboard') }}"><i class="bx bx-right-arrow-alt"></i>Admin</a>
				</li>
				<li> <a href="{{ url('/') }}"><i class="bx bx-right-arrow-alt"></i>Home</a>
				</li>
			</ul>
		</li>
		<!-- Satu -->
		...
		<!-- Empat -->
		<li class="menu-label">Postingan</li>
		<li>
			<a href="widgets.html">
