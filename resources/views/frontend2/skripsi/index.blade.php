...
<section class="section checkout">
    <div class="container">
            <a class="au-btn au-btn--solid au-btn-lg" href="{{ url('history-skripsi') }}">History</a>
        <header class="entry-header">
            <h2 class="entry-title">Pengajuan Judul Skripsi</h2>
        </header>
        <div class="entry-content">
            <form action="{{ url('pengajuan-skripsi') }}" method="POST">
            	{{ csrf_field() }}
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="woocommerce-additional-fields">
                            <h3 class="title-7 m-b-15">Detail Pengajuan Skripsi</h3>
                            <div class="form-group" style="font-size: 15px">
