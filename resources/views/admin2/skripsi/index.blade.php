...
@section('title')
	Data Pengajuan Judul Skripsi Mahasiswa
@endsection
...
<div class="page-content">
	...
	<h6 class="mb-0 text-uppercase">Data Pengajuan Judul Skripsi</h6>
	<hr/>
	<div class="card">
		<div class="card-body">
				...
				<table id="example2" class="table table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							@endif
							<td>
								<a href="{{ url('edit-skripsi/'.$item->id) }}" style="font-size: 25px; margin-left: 10px; color: rgb(80,80,80);"><i class="bx bx-pencil"></i></a>
						  ...
						  <div class="modal-dialog modal-dialog-centered">
						    <div class="modal-content">
						      <div class="modal-header">
						        <h5 class="modal-title" id="exampleModalLabel" style="font-weight: 600;">Hapus Pengajuan Judul Skripsi</h5>
						        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
						      </div>
						      <div class="modal-body">
						        <span style="font-weight: 500; font-size: 15px;">Anda Yakin Akan Menghapus Data Skripsi {{ $item->id }} ?</span>
						      </div>
						      <div class="modal-footer">
						        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
						        <a href="{{ url('delete-skripsi/'.$item->id) }}" class="btn btn-primary">Hapus</a>
						      </div>
						    </div>
						  </div>
						</div>
