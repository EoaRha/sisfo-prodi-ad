...
@section('title')
	Update Pengajuan Judul KKL Mahasiswa
@endsection
		...
		<div class="ps-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					<li class="breadcrumb-item"><a href="{{ url('adm-kkl') }}">Kuliah Kerja Lapangan</a>
					</li>
...
<form action="{{ url('update-kkl/'.$kkl->id) }}" method="POST" enctype="multipart/form-data">
@csrf
@method('PUT')
	<div class="row">
		<div class="col-xl-9 mx-auto">
			<h6 class="mb-0 text-uppercase">Data Pengajuan KKL Mahasiswa</h6>
			<hr/>
			<div class="card">
				<div class="card-body">
					<div class="input-group mb-3"> <span class="input-group-text" id="inputGroup-sizing-default" style="font-weight: 600">NIM</span>
						<input type="text" readonly value="{{ $kkl->nomor_mahasiswa }}" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>

					<div class="input-group mb-3"> <span class="input-group-text" id="inputGroup-sizing-default" style="font-weight: 600">Kelas</span>
						<input type="text" readonly value="{{ $kkl->kelas }}" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>

					<div class="input-group mb-3"> <span class="input-group-text" id="inputGroup-sizing-default" style="font-weight: 600">Nama</span>
						<input type="text" readonly value="{{ $kkl->nama_mahasiswa }}" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
				</div>
			</div>
			...
			<div class="card">
				<div class="card-body">
					<div class="input-group mb-3"> <span class="input-group-text" style="font-weight: 600">Judul</span>
						<textarea class="form-control" name="judul" aria-label="With textarea">{{ $kkl->judul }}</textarea>
					</div>

					<div class="input-group mb-3"> <span class="input-group-text" style="font-weight: 600">Deskripsi</span>
						<textarea class="form-control" name="deskripsi" aria-label="With textarea">{{ $kkl->deskripsi }}</textarea>
					</div>
				</div>
			</div>
